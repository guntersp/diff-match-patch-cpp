...
#define DEFINE_TEST(Traits, Group, Test)                                                                                                            \
    TEST_CASE(#Traits "_" #Group "_" #Test, #Group "_" #Traits) { dmp::tests::Group<dmp::tests::test_traits<traits>>::Test(); }

#define assertEquals(Comment, Value1, Value2) REQUIRE(Value1 == Value2)
#define assertFalse(Comment, Value1) REQUIRE_FALSE(Value1)
#define assertTrue(Comment, Value1) REQUIRE(Value1)
#define assertGreater(Comment, Value1, Value2) REQUIRE(Value1 > Value2)
#define assertLessEqual(Comment, Value1, Value2) REQUIRE(Value1 < Value2)
