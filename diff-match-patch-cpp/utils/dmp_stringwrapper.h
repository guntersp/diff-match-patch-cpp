...
struct string_wrapper {
    ...
    inline constexpr string_wrapper(const string_t& s) noexcept
        : s(s) {}
    inline constexpr string_wrapper(string_t&& s) noexcept
        : s(std::move(s)) {}

    inline constexpr string_wrapper(const string_wrapper& s) noexcept
        : s(s.s) {}
    inline constexpr string_wrapper(string_wrapper&& s) noexcept
        : s(std::move(s.s)) {}


    inline constexpr string_wrapper(char_t s) noexcept
        : s(&s, 1) {}
    inline constexpr string_wrapper(const char_t* s) noexcept
        : s(s, stringLength(s)) {}
    inline constexpr string_wrapper(const char_t* s, size_t length) noexcept
        : s(s, length) {}
    ...
    inline constexpr string_wrapper& operator=(const string_t& s) noexcept {
        if (&s != &this->s) {
            this->s = s;
        }
        return *this;
    ...
    inline constexpr string_wrapper& operator=(string_t&& s) noexcept {
        if (&s != &this->s) {
            this->s = std::move(s);
        }
        return *this;
    ...
    inline constexpr string_wrapper& operator=(const string_wrapper& s) noexcept {
        if (&s != this) {
            this->s = s.s;
        }
        return *this;
    ...
    inline constexpr string_wrapper& operator=(string_wrapper&& s) noexcept {
        if (&s != this) {
            this->s = std::move(s.s);
        }
        return *this;
