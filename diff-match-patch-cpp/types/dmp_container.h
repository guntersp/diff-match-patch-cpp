...
public:
    ...
    inline constexpr element_t&       operator[](int index) noexcept { return (*elements)[index]; }
    inline constexpr const element_t& operator[](int index) const noexcept { return (*elements)[index]; }
};
