...
#include "traits/dmp_clock_traits_none.h"
...
static_assert(diff_commonPrefixTest());
...
static_assert(diff_commonSuffixTest());
...
static_assert(diff_commonOverlapTest());
...
static_assert(diff_halfmatchTest());
...
static_assert(diff_linesToCharsTest());
...
static_assert(diff_charsToLinesTest());
...
static_assert(diff_cleanupMergeTest());
...
static_assert(diff_cleanupSemanticLosslessTest());
...
static_assert(diff_cleanupSemanticTest());
...
static_assert(diff_cleanupEfficiencyTest());
...
static_assert(diff_prettyHtmlTest());
...
static_assert(diff_levenshteinTest());
...
static_assert(match_alphabetTest());
...
static_assert(patch_patchObjTest());
...
static_assert(patch_fromTextTest());
...
static_assert(patch_toTextTest());
...
static_assert(patch_addContextTest());
...
static_assert(patch_splitMaxTest());
...
static_assert(patch_addPaddingTest());
...
clang++ -O2 -o diff_match_patch -I diff-match-patch -I googletest\include -I googletest -std=c++17 diff-match-patch\tests\dmp_test_constexpr.cpp

Compile instructions for LLVM on windows:
clang-cl" /O2 /Idiff-match-patch /Igoogletest\include /Igoogletest /std:c++17 diff-match-patch\tests\dmp_test_constexpr.cpp

if it compiled, all tests have passed
*/
