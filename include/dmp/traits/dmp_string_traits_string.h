...
#ifndef DIFF_MATCH_PATCH_STRINGTRAITS_STRING_H
#define DIFF_MATCH_PATCH_STRINGTRAITS_STRING_H
...
struct string_traits<std::string> {
    ...
    using owning_string_t              = std::string;
    using string_view_t                = utils::string_wrapper<std::string_view, char_t>;
...
using std_string_traits = traits::string_traits<std::string>;
