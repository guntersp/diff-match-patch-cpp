...
struct utf32_from_utf8 {
    ...
    inline static constexpr iterator to_utf32(iterator i, iterator end, utf32_t& u) noexcept {
        ...
        while (i != end) {
            ...
            if (u < 0x80) {
                ...
                u = ((u & 0xF) << 12) + ((static_cast<utf32_t>(*i) & 0x3F) << 6);
                if (i == end || (*i & 0xC0) != 0x80) {
                    continue;
                }
                u += *i & 0x3F;
                ...
                u = ((u & 7) << 18) + ((static_cast<utf32_t>(*i) & 0x3F) << 12);
                if (i == end || (*i & 0xC0) != 0x80) {
                    continue;
                }
                u += (static_cast<utf32_t>(*i) & 0x3F) << 6;
                if (i == end || (static_cast<utf32_t>(*i) & 0xC0) != 0x80) {
                    continue;
                }
                u += static_cast<utf32_t>(*i) & 0x3F;
                return i;
            }
        }
    ...
    inline static constexpr iterator from_utf32(utf32_t u, iterator o) noexcept {
        ...
        // utf32 -> utf8
        if (u < 0x80)
            *o++ = static_cast<Type>(u);
        else if (u < 0x800) {
            *o++ = static_cast<Type>((u >> 6) | 0xC0);
            *o++ = static_cast<Type>((u & 0x3F) | 0x80);
        } else if (u < 0x10000) {
            *o++ = static_cast<Type>((u >> 12) | 0xE0);
            *o++ = static_cast<Type>(((u >> 6) & 0x3F) | 0x80);
            *o++ = static_cast<Type>((u & 0x3F) | 0x80);
        } else {
            *o++ = static_cast<Type>((u >> 18) | 0xF0);
            *o++ = static_cast<Type>(((u >> 12) & 0x3F) | 0x80);
            *o++ = static_cast<Type>(((u >> 6) & 0x3F) | 0x80);
            *o++ = static_cast<Type>((u & 0x3F) | 0x80);
        }
